...
{
    /// <inheritdoc />
    public partial class qrmultiples : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DetallesVenta_Entradas_EntradaId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EntradasVenta", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EntradasVenta_AspNetUsers_UsuarioId",
                        column: x => x.UsuarioId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EntradasVenta_Entradas_EntradaId",
                        column: x => x.EntradaId,
                        principalTable: "Entradas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EntradasVenta_Ventas_VentaId",
                        column: x => x.VentaId,
                        principalTable: "Ventas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EntradasVenta_EntradaId",
                table: "EntradasVenta",
                column: "EntradaId");

            migrationBuilder.CreateIndex(
                name: "IX_EntradasVenta_UsuarioId",
                table: "EntradasVenta",
                column: "UsuarioId");

            migrationBuilder.CreateIndex(
                name: "IX_EntradasVenta_VentaId",
                table: "EntradasVenta",
                column: "VentaId");
